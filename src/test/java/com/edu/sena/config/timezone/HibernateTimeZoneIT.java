package com.edu.sena.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.edu.sena.IntegrationTest;
import com.edu.sena.repository.timezone.DateTimeWrapper;
import com.edu.sena.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM yps_date_time_wrapper where id=%d", fieldName, id);
    }
